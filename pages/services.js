    ...
    <div>
      ...
      <div className="px-8 py-16 space-y-24 bg-gray-50">
        ...
        <section className="bg-white p-12 rounded-lg shadow-md space-y-8 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Our clients love working with us. Here&rsquo;s what they have to say
            about our services.
          </p>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <blockquote className="p-6 bg-gray-100 rounded-lg shadow">
              <p className="text-gray-600">
                &ldquo;Excellent virtual tours that made me feel confident even
                before visiting in person.&ldquo;
              </p>
              <cite className="mt-4 text-sm font-semibold text-gray-700">
                - James P.
              </cite>
        ...
        <section className="text-center space-y-8">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Yes, we provide in-depth market analysis for our clients to help
