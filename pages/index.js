            ...
            <div className="flex flex-col md:flex-row justify-center">
              ...
              <div className="w-full md:w-4/6 py-1 pl-0 md:pl-14">
                ...
                <p className="md:px-0">
                  ...
                  modern apartments in the city to spacious homes in the
                  suburbs, we have something to suit every lifestyle and budget.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="w-full md:w-1/2 px-0 md:px-10">
                <div className="py-5 hidden md:flex flex-col space-y-5">
                  ...
                  <div className="pr-9 text-[#ababab]">
                    ...
                    navigate the property market with confidence and make
                    informed decisions.
                  </div>
